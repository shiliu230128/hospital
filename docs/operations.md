...
完整的 GitHub 开通步骤请看 [docs/github-pages-setup.md](/Users/shiliu/Documents/hospital-app/docs/github-pages-setup.md)。
...
如果是第一次开通，优先按新文档里的 6 步走完。这里补充两个最容易漏的点：

- `Refresh data and deploy Pages` 是 Actions 里的工作流名字，不是本地文件名。
- 如果看不到它，通常是 `.github/workflows/refresh-and-deploy.yml` 没有一起上传，或者仓库 Actions 被禁用了。
