...
`Refresh data and deploy Pages` 不是文件名，而是 GitHub `Actions` 页面里的工作流名字。
...
完整操作看 [docs/github-pages-setup.md](/Users/shiliu/Documents/hospital-app/docs/github-pages-setup.md)。
