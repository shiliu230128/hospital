...
from update_data_once import parse_all_city_registries  # noqa: E402
...
def main() -> int:
    ...
    SCHEDULE_JS_FILE.write_text(build_frontend_schedule_js(records_by_city, report), encoding="utf-8")
